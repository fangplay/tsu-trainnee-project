...
$db = getDbInstance();
$select = array('std_id', 'prename', 'name_th', 'name_en', 'surname_th', 'surname_en','', 'phone','created_at','updated_at');

//Start building query according to input parameters.
// If search string
if ($search_string) 
{
    $db->where('name_th', '%' . $search_string . '%', 'like');
    $db->orwhere('name_en', '%' . $search_string . '%', 'like');
    $db->orwhere('surname_th', '%' . $search_string . '%', 'like');
    $db->orwhere('surname_en', '%' . $search_string . '%', 'like');
}
